package com.nrgedge.jaxrs.doclet.parser;

import com.google.common.base.Predicate;
import com.nrgedge.jaxrs.doclet.DocletOptions;
...
public class AnnotationHelper {
    ...
    private static final String CXF_MULTIPART_FORM_PARAM = "org.apache.cxf.jaxrs.ext.multipart.Multipart";
    ...
    public static String typeOf(String javaType) {
        ...
        if (type.equalsIgnoreCase("integer")) {
            type = "int";
        } else if (type.equalsIgnoreCase("list") || type.equalsIgnoreCase("arraylist") || type.equalsIgnoreCase("linkedlist")) {
            type = "array";
        } else if (type.equalsIgnoreCase("bigdecimal")) {
            type = "string";
        } else if (type.equalsIgnoreCase("inputstream") || type.equalsIgnoreCase("byte")) {
            type = "file";
        }
        return type;
    }
    
    public static String itemsTypeOf(String javaType) {
        String type;
        if (javaType.startsWith("java.lang.")) {
            int i = javaType.lastIndexOf(".");
            type = javaType.substring(i + 1).toLowerCase();
    ...
    public static String paramTypeOf(Parameter parameter) {
        ...
        if (p.isAnnotatedBy(JAX_RS_PATH_PARAM)) {
            ...
            return "query";
        } else if(p.isAnnotatedBy(JAX_RS_FORM_PARAM) || p.isAnnotatedBy(JERSEY_MULTIPART_FORM_PARAM) || p.isAnnotatedBy(CXF_MULTIPART_FORM_PARAM)) {
        	return "form";
        }
        return "body";
    }
