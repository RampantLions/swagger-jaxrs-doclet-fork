...
import com.nrgedge.jaxrs.doclet.model.*;
import com.nrgedge.jaxrs.doclet.translator.Translator;
...
import static com.nrgedge.jaxrs.doclet.parser.AnnotationHelper.parsePath;
    ...
    public Method parse() {
        ...
        if (type.asParameterizedType() != null) {
            ...
            if (typeArguments.length > 0) {
            	...
            	genericReturnType = translator.typeName(typeArguments[0]).value();
            }
        }
        ...
        if (options.isParseModels()) {
            ...
            if (genericType != null) {
            	models.addAll(new ApiModelParser(options, translator, genericType).parse());
            }
        }
